        ...
        <section className=" mx-auto">
            <div className="sm:flex mt-8 sm:items-center sm:justify-between">
                ...
                <div className="flex items-center  gap-x-3">
                    ...
                    <button className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-emerald-500 rounded-lg sm:w-auto gap-x-2 hover:bg-emerald-600 dark:hover:bg-emerald-500 dark:bg-emerald-600">
